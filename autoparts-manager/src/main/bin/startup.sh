...
_JAR_KEYWORDSalicm-open-admin-1.0.jar
APP_NAME=alicm-open-admin

echo "##### run option is #######"
echo "JAVA_OPTIONS_INITIAL=$JAVA_OPTIONS_INITIAL"
echo "JAVA_OPTIONS_MAX=$JAVA_OPTIONS_MAX"

echo "##### App Info #######"
echo "_JAR_KEYWORDS=$_JAR_KEYWORDS"
...
java -jar $JAVA_OPTIONS_INITIAL $JAVA_OPTIONS_MAX $_JAR_KEYWORDS & 
